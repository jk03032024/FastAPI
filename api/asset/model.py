...
class SiteAssets(BaseModel):
    id: UUID = Field(default_factory=uuid4)
    app_short_code: str
    asset_model_short_code: str
    display_name: str
    no_of_linked_iothubdevices: Any
    customer_id: None | UUID = Field(default_factory=uuid4)
    site_id: None | UUID = Field(default_factory=uuid4)
    fleet_id: None | UUID = Field(default_factory=uuid4)
    superasset_id: None | UUID = Field(default_factory=uuid4)
    contextual_data_captured: Any
    image_uri: str
